...
function enviarCorreoBienvenida(string $correoDestino, string $nombre, string $apellido, string $cedula): bool {
    ...
    try {
        ...
        // Remitente (mismo que el autenticado para evitar bloqueos)
        ...
        // Contenido
        $mail->isHTML(true);
        $mail->Subject = 'Bienvenido al Sistema MenuMVC';
        $mail->Body = '
